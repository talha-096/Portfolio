...
PRIMARY_DATABASE_URL = os.getenv(
    "DATABASE_URL",
    r"mssql+pyodbc:///?odbc_connect=Driver={ODBC Driver 17 for SQL Server};Server=.\SQLEXPRESS;Database=portfolio_db;Trusted_Connection=yes;TrustServerCertificate=yes"
)
...
try:
    print(f"Connecting to MS SQL Server instance (.\\SQLEXPRESS)...")
